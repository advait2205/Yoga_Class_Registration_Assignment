...
// This is the main route file in which various functions are handled

// Load index.ejs file which contains main frontend
router.get('/', function (req, res, next) {
	return res.render('index.ejs');
});

// When register is clicked information is extracted from form and then after checking corner cases the data is then binded to mongoose schema
// and then added to MongoDb Atlas Database
